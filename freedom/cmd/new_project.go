...
func mkdirAll(projectPath string) {
	...
	os.MkdirAll(projectPath+"/application/object", os.ModePerm)
	os.MkdirAll(projectPath+"/application/aggregate", os.ModePerm)
	os.MkdirAll(projectPath+"/application/entity", os.ModePerm)
	os.MkdirAll(projectPath+"/application/dto", os.ModePerm)
