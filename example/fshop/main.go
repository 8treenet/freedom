...
import (
	...
	"github.com/8treenet/freedom/example/fshop/config"

	//需要开启 config/infra/kafka.toml open = true
...
func main() {
	...
	addrRunner := app.NewH2CRunner(config.Get().App.Other["listen_addr"].(string))
