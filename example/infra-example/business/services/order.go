...
func (srv *OrderService) Get(id, userId int) (result models.OrderRep, e error) {
...
func (srv *OrderService) GetAll(userId int) (result []models.OrderRep, e error) {
	...
	for _, obj := range objs {
		...
		result = append(result, models.OrderRep{
			ID:        obj.ID,
			GoodsID:   obj.GoodsID,
